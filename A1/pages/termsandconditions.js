    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <h2 className={styles.heasdings}>2. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className={styles.heasdings}>3. User Responsibilities</h2>
          <ul>
          ...
          <h2 className={styles.heasdings}>4. Intellectual Property</h2>
          <p>
          ...
          <h2 className={styles.heasdings}>5. Prohibited Activities</h2>
          <ul>
          ...
          <h2 className={styles.heasdings}>6. Limitation of Liability</h2>
          <p>
          ...
          <h2 className={styles.heasdings}>7. Modifications to Terms</h2>
          <p>
